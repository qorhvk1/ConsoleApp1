...
namespace RoadBook.CsharpBasic.Chapter12.Examples.Manager
{
    public class IndexManager
    {
        ...
        private readonly string _indexDirectoryPath =
            Environment.CurrentDirectory + _directorySeparator + "indexer";
        ...
        public IndexManager()
        {
            _xmlManager = new Manager.XmlManager
                (Manager.XmlManager.USE_TYPE.READ);
        }
        public void Run()
        {
            ...
            foreach (var content in contentsList)
            {
                ...
                data.Add(new Lucene.Net.Documents.Field
                ...
                data.Add(new Lucene.Net.Documents.Field
                    ...
                    Lucene.Net.Documents.Field.Store.YES,
                    Lucene.Net.Documents.Field.Index.NOT_ANALYZED));
                data.Add(new Lucene.Net.Documents.Field("SUMMARY",
                    content.Summary, Lucene.Net.Documents.Field.Store.YES,
                    Lucene.Net.Documents.Field.Index.NOT_ANALYZED));
                data.Add(new Lucene.Net.Documents.Field("CREATE_DT",
                    content.CreateDt.ToString(),
                    Lucene.Net.Documents.Field.Store.YES,
                    Lucene.Net.Documents.Field.Index.NOT_ANALYZED));
                data.Add(new Lucene.Net.Documents.Field
                    ("CREATE_USER_NM", content.CreateUserNm,
                    Lucene.Net.Documents.Field.Store.YES,
                    Lucene.Net.Documents.Field.Index.NOT_ANALYZED));
                data.Add(new Lucene.Net.Documents.Field("TAGS", content.Tags,
                    Lucene.Net.Documents.Field.Store.YES,
