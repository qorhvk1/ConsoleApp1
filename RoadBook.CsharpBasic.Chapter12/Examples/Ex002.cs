    ...
    public class Ex002
    {
        ...
        private void Crawl()
        {
            ...
            foreach (var book in bookList)
            {
                ...
                data.Add(new Field("ID", book.Title,Field.Store.YES,
                    Field.Index.ANALYZED));
                data.Add(new Field("DESCRIPTION", book.Description,
                    Field.Store.YES, Field.Index.ANALYZED));
                data.Add(new Field("PRICE",book.Price.ToString(),
        ...
        private void Search(string q)
        {
            ...
            var queryParser = new MultiFieldQueryParser(luceneVersion,
                new string[] { "TITLE", "DESCRIPTION" }, _analyzer);
